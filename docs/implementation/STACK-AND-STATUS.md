...
- CopilotKit powers the setup chat in the web panel. It has no calendar action tools; the backend handles bot and panel actions.
...
Start with [Team setup](TEAM-SETUP.md) and [Presentation runbook](DEMO-GUIDE.md). Original upstream BRD/TRD describe the earlier Slack direction; the application and this document describe the implemented Ambiguous flow.
